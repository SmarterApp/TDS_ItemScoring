 ...
 *
 */
public class TEqGetInequalitiesCount extends TinyEqExpression
{

  public TEqGetInequalitiesCount (Element node) {
  ...
  protected DataElement exprEvaluate (VariableBindings vb, QTIRubric rubric, List<DataElement> paramValues) throws QTIScoringException {
    ...
    if (obj == null)
      obj = new DEString ("");
    return new DEInteger (TinyEquation.countInEqualities (obj.toString ()));
  }
}
