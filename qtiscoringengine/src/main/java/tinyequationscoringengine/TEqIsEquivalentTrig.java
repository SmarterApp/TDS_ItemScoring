 ...
 *
 */
public class TEqIsEquivalentTrig extends TinyEqExpression
{
  public TEqIsEquivalentTrig (Element node) {
  ...
  protected DataElement exprEvaluate (VariableBindings vb, QTIRubric rubric, List<DataElement> paramValues) throws QTIScoringException {
    ...
    return new DEBoolean (TinyEquation.getIsEquivalent (obj.toString (), expr.toString (), true, true, false, false));
  }
