...
public class ResponseProcessing
{
  ...
  {
      if (responseProcessing == null) return null;
      ResponseProcessing processor = new ResponseProcessing();
      //XmlNodeList nodes = responseProcessing.SelectNodes(QTIXmlConstants.ResponseRuleElementGroup, nsmgr);
      ...
      for (Element node : nodes)
      {
          ...
          if (rule != null) processor.AddRule(rule);
      }
      return processor;
  }
