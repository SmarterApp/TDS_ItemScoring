...
public class AssociableHotspot extends HotspotChoice
{
  ...
  static/* new */AssociableHotspot fromXml (Element element, XmlNamespaceManager nsmgr, ValidationLog log)
  {
    ...
    {
      // coordList =
      // QTIUtility.ParseDelimitedString(coords).ConvertAll<int>(Convert.ToInt32);
