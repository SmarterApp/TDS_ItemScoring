...
class GapMatchInteraction extends MatchingInteraction
{
  ...
  private GapMatchInteraction (Element elem, List<GapText> gtList, List<Gap> gaps, List<GapImg> giList, String responseIdentifier, boolean shuffle, GapType type)
  ...
  static GapMatchInteraction fromXml (Element element, XmlNamespaceManager nsmgr, ValidationLog log) {
    ...
    List<Element> gapTextNodes = elementToXml.selectNodes (ItemBodyConstants.GapText, nsmgr);
    ...
    List<Element> gapNodes = elementToXml.getElementsByTagName (ItemBodyConstants.Gap);
