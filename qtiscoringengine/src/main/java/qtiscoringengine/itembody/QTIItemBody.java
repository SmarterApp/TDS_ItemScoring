...
/*******************************************************************
 * Note: This is a very incomplete implementation. It only pulls information
 * that is needed for unit testing.
 * 
 * These interactions are not implemented -- I'm not sure how to handle them
 * currently.
 * 
 * -MediaInteraction -ExtendedTextInteraction -UploadInteraction
