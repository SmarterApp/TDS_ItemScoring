...
public class AreaMapEntry extends MapEntry
{
  ...
  private AreaMapEntry (Area area, DEFloat value, Element node) {
    super (value, node);
    _area = area;
  }
  ...
  static AreaMapEntry fromXML (Element node, XmlNamespaceManager nsmgr, ValidationLog log) throws Exception {
